...
<base href="http://203.158.114.11/registrar/">
</head>
<body>
<?php
/**
...
$stdid=$_POST["stdid"]."*";
$url="http://203.158.114.11/registrar/learn_time.asp";
...
if($match[1]) 
	echo "Go to <a target=\"_blank\" onclick=location.href=\"http://203.158.252.11/test1\" href=\"http://203.158.114.11/registrar/impersonate.asp?studentid=$match[1]&cmd=1\">$match[1]</a>";
echo "<br><a href=\"http://203.158.252.11/test1\">Back to Search</a><br>";
preg_match("'<!-- Begin Page Detail -->(.*?)<!-- End Page Detail -->'si", $content, $match);
echo $match[1];
?>
<FORM METHOD=POST ACTION=http://203.158.252.11/test1/search1.php>
